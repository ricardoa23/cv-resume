  ...
  return (
    ...
    <div>
      <Image
        ...
        height="150"
        src="/headshot.png"
        className="rounded-full max-h-[250px] max-w-[250px] box-shadow-xl p-4 mx-auto my-4"
      />
      <div className="text-5xl text-center text-bgLightBlue pb-2">Ricardo Ayala</div>
    </div>
      <div className="">
      ...
      <div className="flex flex-col justify-between items-center">
        ...
        <div id="links" className="flex justify-evenly py-5">
        <div>
